...
class BaseDocument(DataObject):
    ...
    @property
    def as_context(self):
        if self._as_context is None:
            if self.context is not None:
                self._as_context = Context.contextualize(self.context)(ident=self.make_context_identifier())
            else:
                self._as_context = Context(ident=self.make_context_identifier())
