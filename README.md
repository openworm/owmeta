...
PyOpenWorm.statement.Statement(subj=Neuron(ident=?aNeuron_1), prop=PyOpenWorm.neuron.Neuron_neuropeptide(owner=Neuron(ident=?aNeuron_1)), obj=yarom.propertyValue.PropertyValue(rdflib.term.Literal('INS-26')), context=PyOpenWorm.context.QueryContext(ident="http://openworm.org/entities/bio#worm0-data"))
