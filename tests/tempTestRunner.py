# Temporary file with @travs to test a new test suite loader
# that will allow us to run tests individually.  This
# will eventually be removed and merged into test.py
...
if __name__ == '__main__':
    # Check if there is a 3rd argument, and run the test directly
    # Otherwise, do the whole thing as before.  
